...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "size-10 hover:bg-accent/50 transition-colors duration-200",
        className
      )}
      onClick={(event) => {
        onClick?.(event);
      ...
      {...props}
    >
      <PanelLeftIcon className="transform transition-transform duration-200 group-data-[state=open]:rotate-180" />
